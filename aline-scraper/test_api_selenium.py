#!/usr/bin/env python3
"""
Test script for Selenium-enhanced guide scraping through API
"""

import requests
import json

def test_guide_scraping_api():
    """Test guide scraping through the API with Selenium support."""
    
    # Test the guide collection URLs
    test_requests = [
        {
            "team_id": "test_team",
            "user_id": "test_user",
