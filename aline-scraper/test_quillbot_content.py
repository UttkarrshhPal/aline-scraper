...
def test_quillbot_content():
    """Test content extraction from a QuillBot blog post."""
    
    # Test with the main blog URL
    test_url = "https://quillbot.com/blog"
    
    print(f"Testing QuillBot content extraction: {test_url}")
